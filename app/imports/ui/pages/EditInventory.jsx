...
import { AutoForm, ErrorsField, HiddenField, NumField, SubmitField } from 'uniforms-semantic';
...
class EditInventory extends React.Component {
  ...
  submit(data) {
    const { owned, _id } = data;
    Inventory.collection.update(_id, { $set: { owned } }, (error) => (error ?
...
export default withTracker(({ match }) => {
  ...
  return {
    doc: Inventory.collection.findOne(documentId),
